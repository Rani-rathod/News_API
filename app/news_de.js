...
const NewsDe = () => {
  return (
    <div className='container'>
      <div className="row my-5 border border-dark productCo">
        <div className="row">
          <div className="col-3 product1 border">Top News from India</div>
        </div>
        <div className="row ">
          <div className="col-4 product2 border"></div>
          <div className="col-4 product2 border"></div>
          <div className="col-4 product2 border"></div>
        </div>
      </div>
